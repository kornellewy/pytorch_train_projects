...
def ResNet50(ing_channels=3, num_classes=1000):
    return ResNet(block, [3,4,6,3], ing_channels, num_classes)

def ResNet101(ing_channels=3, out_channels=1000):
    return ResNet(block, [3,4,23,3], ing_channels, num_classes)

def ResNet152(ing_channels=3, out_channels=1000):
    return ResNet(block, [3,8,36,3], ing_channels, num_classes)
